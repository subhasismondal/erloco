...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        if ($role == 'USER') {
            ...
            $totalcountSDAH =Loco::where([['created_at', '>=', Carbon::today()], ['division', '=', 'SDAH']])->count();
            ...
            return view('home', ['name' => $name, 'date' => $date,'totalcountHWH' => $totalcountHWH,'totalcountSDAH' => $totalcountSDAH, 'totalcountMLDT' => $totalcountMLDT, 'totalcountASN' => $totalcountASN, 'division' => $division,'locodetailsToday' => $locodetailsToday,'role'=>$role]);
        } else if ($role == 'ADMIN') {
            $date = date('d-m-Y');
            ...
            return view('home', ['name' => $name, 'date' => $date, 'division' => $division, 'role'=>$role,'totalcountHWH' => $totalcountHWH,'totalcountSDAH' => $totalcountSDAH, 'totalcountMLDT' => $totalcountMLDT, 'totalcountASN' => $totalcountASN,'locodetailsTodayHWH' => $locodetailsTodayHWH,'locodetailsTodayMLDT' => $locodetailsTodayMLDT,'locodetailsTodayASN' => $locodetailsTodayASN,'locodetailsTodaySDAH' => $locodetailsTodaySDAH]);
        }
    }
}
